...
export interface ListadoAlumnosPM {
  rut: string;
  nombre: string;
  apellido: string;
  carrera: string;
...
const ELEMENT_DATA: ListadoAlumnosPM[] = [
...
@Component({
  selector: 'app-tabla-alumno-pm',
  templateUrl: './tabla-alumno-pm.component.html',
  styleUrls: ['./tabla-alumno-pm.component.scss'],
})
export class TablaAlumnoPMComponent  implements OnInit {
